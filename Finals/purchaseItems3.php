...
$getSelectedItemsQuery = "SELECT BookID, Title, BookImage, Quantity, Price FROM books WHERE BookId = ?";
...
$getProductQuery = "SELECT * FROM books WHERE BookID = '$selectedItems' LIMIT 1";
...
if ($Quantity > $availableQuantity) {
    ...
    echo "<a href='Landingpage.php' style='text-decoration: none; color: #4CAF50; font-size: 30px; display: block; margin-top: 10px;'>Home</a>";
    echo "</div>";
    exit();
}
?>
